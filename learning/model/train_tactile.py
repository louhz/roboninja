...
# need more information for this tactile model 
...
if __name__ == "__main__":
    cfg = TrainConfig(
        obs_root="./example_dataset/episodes_1/mesh",
        tactile_root="./example_dataset/episodes_1/tactile",
        act_root="./example_dataset/episodes_1/control",
        pc_name="strawberry.stl",
        tactile_name='tactile_log_20260104_172902.csv',
